#ifndef SHA256_COMMITMENT_COPY_GADGET_TCC
#define SHA256_COMMITMENT_COPY_GADGET_TCC

#include "sha256_commitment_copy_gadget.hpp"
...
SHA256CommitmentCopyGadget<FieldT>::SHA256CommitmentCopyGadget(
...
template<typename FieldT>
void SHA256CommitmentCopyGadget<FieldT>::generate_r1cs_constraints()
{
...
template<typename FieldT>
void SHA256CommitmentCopyGadget<FieldT>::generate_r1cs_witness(const bit_vector& random_vector)
{
...
template<typename FieldT>
const pb_variable_array<FieldT>& SHA256CommitmentCopyGadget<FieldT>::get_value_bits() const
{
	return value.bits;
}
...
#endif // SHA256_COMMITMENT_COPY_GADGET_TCC
