#ifndef SHA256_COMMITMENT_COPY_GADGET_HPP
#define SHA256_COMMITMENT_COPY_GADGET_HPP
...
class SHA256CommitmentCopyGadget : public libsnark::gadget<FieldT> {
...
public:
	SHA256CommitmentCopyGadget(libsnark::protoboard<FieldT> &pb,
...
#include "sha256_commitment_copy_gadget.tcc"
