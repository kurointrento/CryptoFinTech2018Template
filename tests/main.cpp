...
using unitn_crypto_fintech::SHA256CommitmentGadget;
...
class SHA256CommitmentTest : public ::testing::Test {
protected:
	...
	shared_ptr<SHA256CommitmentGadget<DefaultField>> sha256_commitment_gadget;
	...
	SHA256CommitmentTest() {
		...
		sha256_commitment_gadget = make_shared<SHA256CommitmentGadget<DefaultField>>(
...
TEST_F(SHA256CommitmentTest, WitnessSatisfiesCircuit) {
	pb->val(value) = 0;
...
TEST_F(SHA256CommitmentTest, WrongCommitmentDoesNotSatisfyCircuit) {
	pb->val(value) = 0;
...
TEST_F(SHA256CommitmentTest, CircuitGeneratesCorrectProof) {
	pb->val(value) = 0;
...
TEST_F(SHA256CommitmentTest, CircuitRecognizesWrongProof) {
	pb->val(value) = 0;
